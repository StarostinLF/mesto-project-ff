...
const exampleName = 'Новая карточка';
const exampleLink = 'https://example.com/image.jpg';

export default function CardModal({ onClose }: { onClose: () => void }) {
			...
			>
				...
				<form className={'flex flex-col gap-13'} onSubmit={handleSubmit}>
					<div className={'relative flex flex-col gap-1'}>
						<label aria-label={'Название карточки'} htmlFor={'name'} hidden>
							Название
						</label>
						<input
